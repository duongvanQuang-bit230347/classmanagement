...
<body>
    ...
    <div class="main-content">
        <div class="card">
            ...
            <c:if test="${user.role == 'ADMIN'}">
                <div class="mb-3">
                    <a href="room?action=addForm" class="btn btn-success">Thêm phòng</a>
                </div>
            </c:if>
                ...
                <tbody>
                    <c:forEach var="room" items="${rooms}">
                        <tr>
                            ...
                            <td>
                                <c:if test="${user.role == 'ADMIN'}">
                                    <a href="room?action=editForm&id=${room.id}" class="btn btn-warning btn-sm">Sửa</a>
                                    <a href="room?action=history&id=${room.id}" class="btn btn-info btn-sm">Lịch sử</a>
                                    <button type="button" class="btn btn-danger btn-sm" onclick="confirmDeleteRoom(${room.id})">Xóa</button>
                                </c:if>
                            </td>
                        </tr>
                    </c:forEach>
