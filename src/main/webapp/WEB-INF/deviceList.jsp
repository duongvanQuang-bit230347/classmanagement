...
<body>
    ...
    <div class="main-content">
        <div class="card">
            ...
            <c:if test="${user.role == 'ADMIN'}">
                <div class="mb-5">
                    <a href="device?action=addForm" class="btn btn-success">Thêm Thiết Bị</a>
                </div>
            </c:if>
                ...
                <tbody>
                    <c:forEach var="device" items="${devices}">
                        <tr>
                            ...
                            <td>${device.roomId}</td>
                            <td>${device.status}</td>
                            <td>${device.conditionNotes}</td>
                            <td>
                                <c:if test="${user.role == 'ADMIN'}">
                                    <a href="device?action=editForm&id=${device.id}" class="btn btn-warning btn-sm">Sửa</a>
                                    <button type="button" class="btn btn-danger btn-sm" onclick="confirmDeleteDevice(${device.id})">Xóa</button>
                                </c:if>
                            </td>
                        </tr>
                    </c:forEach>
