...
<body>
    ...
    <div class="main-content">
        <div class="card">
            <h2 class="title">Danh sách Yêu cầu Đặt phòng</h2>
            <c:if test="${user.role == 'GV' || user.role == 'SV'}">
                <div class="mb-5">
                    <a href="booking?action=create" class="btn btn-success">Tạo yêu cầu mới</a>
                </div>
            </c:if>
                            ...
                            <td>
                                <c:if test="${user.role == 'ADMIN'}">
                                    <c:if test="${booking.status == 'PENDING'}">
                                        <a href="booking?action=approve&id=${booking.id}" class="btn btn-success btn-sm">Duyệt</a>
                                        <a href="booking?action=cancel&id=${booking.id}" class="btn btn-danger btn-sm">Hủy</a>
                                    </c:if>
